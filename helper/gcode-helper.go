...
func GCodeToImage(path string) {
	...
	dirName := fmt.Sprintf("%v/thumbnails", config.TempFileDir)
	...
	f, err := os.OpenFile(fmt.Sprintf("%v/thumbnails/test.png", config.TempFileDir), os.O_WRONLY|os.O_CREATE, 0777)
	if err != nil {
